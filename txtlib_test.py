...
#like this one.
#\n\nYou can also make hurra bold text, italic text and underline text.
...
#text.add_style(0,3, txtlib.BOLD)
...
html = '''
    <font="Arial"><size="15"><b>RCMower - </b><color="255,0,0">ERROR</color> - no controller device found</size></font>
    '''
    
html2 = '''<font="Arial"><size="15"><b>RCMower - </b>'''
html2+= '''<color="230,100,10">''' + "{:<10}".format("ERROR") + "</color>"
html2+= '''this is my text</font></size>'''

text.html("'"+html2+"'")
#text.html(""+html2+"")
#text.html('\n\nLog format <U><i><b>html</B></i></U>. <color="255, 0, 0">Colore</color>, <size="10">size</s>, <foNt="azfhh">font</FONT>')
